import CardsDaftarToko from './CardsDaftarToko';
...
describe('<CardsDaftarToko />', () => {
    ...
    it('not loading when card test', () => {
        ...
        render(
            <Provider store={store}>
                <BrowserRouter>
                    <CardsDaftarToko posts={mockCurrentPosts} loading={false} />
                </BrowserRouter>
            </Provider>);
    ...
    it('loading when card test', () => {
        ...
        render(
            <Provider store={store}>
                <BrowserRouter>
                    <CardsDaftarToko posts={mockCurrentPosts} loading={true} />
                </BrowserRouter>
            </Provider>);
        localStorage.removeItem('access', 'token')
    });
