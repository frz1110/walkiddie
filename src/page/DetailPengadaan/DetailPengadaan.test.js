...
describe('<DetailPengadaan />', () => {
    ...
    it('fetches unsuccessfully from pengadaan API', () => {
        const mockUser = jest.fn()
        const mockAuthenticate = jest.fn()
        const mockMatch = {
            params: {
        ...
        mock.onGet(`${process.env.REACT_APP_BACKEND_API_URL}/api/pengadaan/2`, config).reply(401, investasiData);
    ...
    it('fetches unsuccessfully from toko API', () => {
        const mockUser = jest.fn()
        const mockAuthenticate = jest.fn()
        const mockMatch = {
            params: {
        ...
        mock.onGet(`${process.env.REACT_APP_BACKEND_API_URL}/api/toko/1`, config).reply(401, investasiData);
